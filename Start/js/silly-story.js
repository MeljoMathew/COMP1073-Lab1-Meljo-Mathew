...
var randomize = document.getElementById("generate");
...
function result() {
    ...
    */
    ...
    if (document.getElementById("metric").checked) {
        ...
        var weight = (300 * 0.453592).toFixed(2); // Convert to kg
        ...
        var temp = ((94 - 32) * 5 / 9).toFixed(2); // Convert to °C
        // STEP 12b: Replace the string '94 fahrenheit' with the updated temperature in °C
        newStory = newStory.replace(/94 fahrenheit/g, temp + '°C');
    }
